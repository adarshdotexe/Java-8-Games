...
public class SnakeGame extends JFrame {
	...
	public static class SidePanel extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			g.drawString("Designed By", getWidth() / 2 - g.getFontMetrics().stringWidth("Designed By") / 2, drawY+= 80);
			g.setFont(MEDIUM_FONT);
			g.drawString("Adarsh Varshney", getWidth() / 2 - g.getFontMetrics().stringWidth("Adarsh Varshney") / 2, drawY += 25);
		}
